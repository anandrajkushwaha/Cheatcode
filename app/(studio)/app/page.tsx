...
export default async function StudioHomePage({
  ...
  const buckets: Bucket[] = [
    { key: "all", label: "All roles", total: all.total, jobs: all.jobs, href: "/app/jobs" },
    ...(inCities
      ? [
          {
            key: "cities",
            ...
            jobs: inCities.jobs,
            href: `/app/jobs?t=1&cities=${encodeURIComponent(cities.join(","))}`,
          },
        ]
      : []),
    {
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[236px_minmax(0,1fr)] xl:grid-cols-[236px_minmax(0,1fr)_252px]">
      {/* /app's own identity card, pointed at /app. Not a studio copy of
